...
var isEven = function(n) {
  // keep substracting by 2 until we hit either 0 or 1
  n = Math.abs(n);
  if (n === 1) {
    return false;
  }
...
var range = function(x, y) {
  // if there's no range, return empty array
...
// modulo(17,5) // 2
// modulo(22,6) // 4
  // keep decrementing x by y until x < y
...
var createArray = function(str) {
  ...
  let array = createArray(str.substr(1));
  array.unshift(str[0]);
  return array;
};
...
var reverseArr = function(array) {
  ...
  let reversed = reverseArr(array.slice(1));
...
var rMap = function(array, callback) {
  ...
  let mapped = rMap(array.slice(1), callback);
  mapped.unshift(callback(array[0]));
  return mapped;
};
...
var capitalizeWords = function(array) {
  ...
  let capitalized = capitalizeWords(array.slice(1));
  capitalized.unshift(array[0].toUpperCase());
  return capitalized;
};
...
var capitalizeFirst = function(array) {
  ...
  let capitalized = capitalizeFirst(array.slice(1));
  array[0] = capitalizeFirstLetter(array[0])
  capitalized.unshift(array[0]);
  return capitalized;
};
